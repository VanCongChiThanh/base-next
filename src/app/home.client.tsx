          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-xl mx-auto">
                Sử dụng trí tuệ nhân tạo để bảo vệ bạn và nâng cao trải nghiệm tìm việc
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {/* Scam Detection */}
              <div className="bg-white rounded-2xl border border-indigo-100 p-6 hover:shadow-lg hover:shadow-indigo-50 transition-all group">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-500 to-orange-400 flex items-center justify-center text-white text-2xl mb-4 group-hover:scale-110 transition-transform">
                  🛡️
                </div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-3">
                  AI tự động phân tích mọi tin tuyển dụng dựa trên quy tắc, mẫu lừa đảo đã biết,
                  và phân tích nội dung để cảnh báo bạn trước khi ứng tuyển.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-xs rounded-full">Rule-based</span>
                  <span className="px-2 py-0.5 bg-blue-50 text-blue-600 text-xs rounded-full">Vector matching</span>
                  <span className="px-2 py-0.5 bg-purple-50 text-purple-600 text-xs rounded-full">AI analysis</span>
                </div>
              </div>

              {/* AI Chatbot */}
              <div className="bg-white rounded-2xl border border-indigo-100 p-6 hover:shadow-lg hover:shadow-indigo-50 transition-all group">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-sky-400 flex items-center justify-center text-white text-2xl mb-4 group-hover:scale-110 transition-transform">
                  💬
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-3">
                  Hỏi đáp tức thì về cách sử dụng nền tảng, quy trình ứng tuyển, thanh toán,
                  và nhận tư vấn an toàn khi tìm việc — sử dụng kiến trúc RAG.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 text-xs rounded-full">RAG Pipeline</span>
                  <span className="px-2 py-0.5 bg-teal-50 text-teal-600 text-xs rounded-full">Gemini AI</span>
                  <span className="px-2 py-0.5 bg-orange-50 text-orange-600 text-xs rounded-full">pgvector</span>
                </div>
              </div>
            </div>
          </div>
